...
class archive extends table {
    function getcols($act) {
        switch ($act) {
            case 'list':
                return 'aid,title,catid,catid,tag,spid,introduce,keyword,view,adddate,userid,author,image,thumb,content,attachment,checked,linkto,ispages,attr3'.$this->mycols();
            case 'modify':
                return 'aid,title,catid,catid,tag,spid,introduce,introduce_len,description,keyword,image,thumb,content,attachment,checked,template,linkto,mtitle,description,keyword,htmlrule,ishtml,province_id,city_id,section_id,attr1,attr3,adddate'.$this->mycols();
            case 'manage':
