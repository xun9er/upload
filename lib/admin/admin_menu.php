    ...
    static function get() {
        ...
        switch ($mod) {
            ...
            case 'celive':
                ...
                break;
            case 'user':
                $menu=self::fetch('用户管理,用户组管理');
                break;
            case 'func':
                $menu=self::fetch('公告管理,留言评论,投票管理,数据管理');
                break;
            case 'defined':
            ...
            case 'help':
                ...
                break;
            case 'seo':
                $menu=self::fetch('数据统计,内容链接管理,推广联盟,友情链接管理,邮件管理');
                break;
            case 'map':
    ...
    static function allmenu() {
        return $menu=array(
                ...
                '内容管理'=>array(
                        ...
                        '热门关键词'=>'javascript:managehotsearch();',
                ),
                '内容链接管理'=>array(
                ...
                '数据统计'=>array(
                        ...
                        'CNZZ全景统计'=>url::create('table/viewcnzz/table/user'),
                ),
                '留言评论'=>array(
                ...
                '生成管理'=>array(
                        ...
                        'Google地图生成'=>url::create('cache/make_sitemap'),
