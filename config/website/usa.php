...
//site-站点信息{
'site_url'=>'http://usa.cmseasy.cn/', //网站地址[http://起始并以 / 结束]
'sitename'=>'cmseasy Content management system', //网站名称
'fullname'=>'cmseasy free content management system', //网站全称
'site_icp'=>'icp no.102030560', //ICP备案号
'site_keyword'=>'company,free website,cmseasy',//网站关键字
'site_description'=>'cmseasy free',//网站描述
'version'=>'V20100808',
'logo_width'=>'324',//logo宽度[单位(px)]
'site_logo'=>'images/logo.gif',//网站logo=>image
'onerror_pic'=>'images/nopic.gif',//列表页默认图片=>image
'site_right'=>'cmseasy all rights reveserd.', //网站版权
