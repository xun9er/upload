...
<input type="hidden" name="dopost" value="upload">
  ...
  <table width="100%" border="0">
    ...
    <tr height="25" onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
      <td colspan="3" nowrap> <fieldset>
        ...
        {loop $uploads $up}
          <table width="100%" border="0" cellspacing="2" cellpadding="0">
          <tr height="30" onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
            <td align="right" nowrap>&nbsp;</td>
            <td colspan="2" nowrap>
