...
<tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
	...
	<td><input type="radio" value="1" name="cashondelivery"> 启用&nbsp;
							<input type="radio" value="0" name="cashondelivery" checked="checked"> 关闭&nbsp;
...
<tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
	...
	<td><input type="radio" value="1" name="insure" onclick="javascript:document.getElementById('insureproportion_box').style.display='';"> 启用&nbsp;
							<input type="radio" value="0" name="insure" checked="checked" onclick="javascript:document.getElementById('insureproportion_box').style.display='none';"> 关闭</td>
</tr>

<tr id="insureproportion_box" style="display:none" onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
	<td class="left">保价比例</td>
	<td><input type="text" name="insureproportion" id="insureproportion" value="{$data['overweight']}"  /></td>
</tr>
