...
<tr>
 ...
 <td>PHP版本</td> <td>5.0以上</td> <td>5.2以上</td> <td><?php echo PHP_VERSION; ?></td> <td align="center"><?php echo helper::yes(PHP_VERSION>=5.0); ?></td>
  ...
  <tr>
 <td>MySQL版本</td> <td>4.1以上</td> <td>5.0以上</td> <td>{=@$mysql_verion}</td> <td align="center">
 {if $pass}
...
<div class="blank10"></div>
<div id="footer">
<div class="copy">Copyright &copy; 2010 CmsEasy.CN, All rights reserved. <a href="http://www.cmseasy.cn" title="Powered by CmsEasy" target="_blank">Powered by CmsEasy</a></div>
</div>
</div>
</body>
</html>