...
<div id="position">
<a href="javascript:managemap();">网站地图</a><a href="{url::create('index/index/mod/cache')}">生成静态</a><a href="index.php?case=table&act=add&table=archive&admin_dir={get('admin_dir')}">添加内容</a><a href="{url::create('config/remove')}">更新缓存</a>当前位置：<?php echo session::get('modname');?>  <?php echo session::get('actname');?><?php if(front::get('deletestate')) echo ' > 回收站'; if(front::get('needcheck')) echo ' > 待审核内容'; ?>
</div>
