<div class="tags">
  ...
  <div id="tagstitle">
   <a id="one1" onclick="setTab('one',1,6)" class="hover">专题[<a href="{special::url($special['spid'])}" target="_blank">{$special[title]}</a>]内容管理</a>
  </div>
    ...
    <table border="0" cellspacing="2" cellpadding="4" class="list" name="table" id="table" width="100%">
        <thead>
            <tr onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
                <th width="60"><input title="点击可全选本页的所有项目"  onclick="CheckAll(this.form)" type="checkbox" name="chkall" class="checkbox" /> </th>
