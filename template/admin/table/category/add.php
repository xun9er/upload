...
<td width="19%" align="right"><span style="  width:auto; font-weight:bold; padding:1px 20px; line-height:30px;  ">在导航中显示</span></td>
                        <td width="1%">&nbsp;</td>
                        <td width="80%">{form::getform('isnav',$form,$field,$data)}  &nbsp;<img src="{$skin_path}/cuo.gif" alt="" width="14" height="14"  style="margin-left:10px; margin-right:5px;">&nbsp;&nbsp;<span class="tips">如果是一级目录，可选择是否在导航中显示栏目名称和链接</span></td>
                    </tr>
...
<td width="19%" align="right"><span style="  width:auto; font-weight:bold; padding:1px 20px; line-height:30px;  ">关键词</span></td>
                        <td width="1%">&nbsp;</td>
                        <td width="80%">{form::getform('keyword',$form,$field,$data)}&nbsp;&nbsp;<img src="{$skin_path}/cuo.gif" alt="" width="14" height="14"  style="margin-left:10px; margin-right:5px;"> <span class="tips"><a href="javascript:tipsbox('网页META信息中的keywords信息，可填写与内容相关的关键词，以英文逗号相隔，有利于搜索优化！');">查看帮助</a></span></td>
                    </tr>

<tr style="border-bottom:1px solid #900" onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
<td width="19%" align="right"><span style="  width:auto; font-weight:bold; padding:1px 20px; line-height:30px;  ">页面描述</span></td>
                        <td width="1%">&nbsp;</td>
                        <td width="80%">{form::getform('description',$form,$field,$data)}&nbsp;&nbsp;<img src="{$skin_path}/cuo.gif" alt="" width="14" height="14"  style="margin-left:10px; margin-right:5px;">&nbsp;&nbsp;<span class="tips"><a href="javascript:tipsbox('网页META信息中的description信息，可填写与内容相关的简介，有利于搜索优化！');">查看帮助</a></span></td>
                    </tr>
