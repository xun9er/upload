<div class="tags">
 ...
 <strong>调用方法：{</strong>ballot(编号)<strong>}</strong>
...
<tbody>
    ...
    <tr class="s_out" onmouseover="this.bgColor='#F5F5F5';" onmouseout="this.bgColor='ffffff';" bgcolor="#ffffff">
      ...
      <td align="center"><a href="javascript:getcontent('addballot',<?php echo $d[$primary_key];?>);">添加选项</a> <a href="<?php echo modify("act/list/table/option/bid/$d[$primary_key]");?>">选项管理</a> <a href="<?php echo modify("act/edit/table/$table/id/$d[$primary_key]");?>">编辑</a> <a onclick="javascript: return confirm('确实要删除吗?');" href="<?php echo modify("/act/delete/table/$table/id/$d[$primary_key]");?>">删除</a></td>
    </tr>
    {/loop}
    </tbody>
