...
echo modify("/act/".front::$act."/table/".$table.$id); ?>"  onsubmit="return checkform();">
               ...
               <table border="0" cellspacing="2" cellpadding="1" class="list" name="table" id="table">
                    <tbody>
                        ...
                        <tr>
                           <td id="tag_box">
                    标签配置<br /><style type="text/css">#tag_box {line-height:32px;}#tag_box input {height:16px;line-height:16px;}#tag_box table {width:100%;}#tag_box table tr td {border-bottom:1px solid #E8EEF6;color:#666;}.left {width:120px;text-align:right;padding-right:15px;}</style>
