...
<img src="template/admin/skin/cuo.gif" alt="" width="14" height="14" / style="margin-left:10px; margin-right:5px;"> <span class="tips">焦点图调用方法：将 {template 'tag/tag_ifocus.html'} 复制到模板内，保存即可。</span>
</body>
</html>
