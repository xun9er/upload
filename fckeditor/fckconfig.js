...
FCKConfig.Plugins.Add('ugeshi', 'zh-cn');

FCKConfig.ToolbarSets["simple"] = [
	['Source','-','Undo','Redo','Cut','Copy','Paste','PasteWord','-','Bold','-','Unlink','-','UploadFile']
] ;
...
FCKConfig.MediaDlgHideAdvanced	= false ;  //这里新增 MediaDlgHideAdvanced
...
//FCKConfig.SmileyPath	= FCKConfig.BasePath + 'images/smiley/haha/' ;
//FCKConfig.SmileyImages	= ['248.gif','249.gif','250.gif','251.gif','253.gif','256.gif','259.gif','265.gif'] ;
//FCKConfig.SmileyColumns = 8 ;
//FCKConfig.SmileyWindowWidth		= 320 ;
//FCKConfig.SmileyWindowHeight	= 210 ;
...
FCKConfig.Plugins.Add('Media', 'en,zh-cn') ; //这里加入了 插入媒体Media插件
FCKConfig.Plugins.Add('insertvideo', 'zh-cn,en'); //这里加入了 Flv视频 插件

FCKConfig.Plugins.Add( 'insertcode' ) ; //这里加入了 插入代码 插件
FCKConfig.Plugins.Add( 'HighLighter', 'zh-cn,en' ) ; //这里加入了 插入高亮代码 插件
